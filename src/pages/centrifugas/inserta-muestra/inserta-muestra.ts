...
@Component({
  ...
  templateUrl: 'inserta-muestra.html',
  providers: [CentrifugasService]
})
export class InsertaMuestra implements OnInit {
  ...
  saveData() {
    ...
    this._centrifugasService.addMuestra(this.centrifuga).subscribe(
      response => {
